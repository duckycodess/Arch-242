...
class arch242emu():
    def __init__(self, binfile):
        ...
        self.ACC = 0b0000
        self.IOA = 0b0000
        self.IOB = 0b0000 #unused
        self.IOC = 0b0000 #unused
        ...
        while self.PC != len(self.ASM_MEM):
            self.CLOCK += 1
    ...
    def read_inst(self, pc, inst):
        ...
        # group 10 (56-57):
        # timer-start, timer-end (deprecated)
        elif val <= 57:
        ...
        # group 11 (58-61):
        # from-timerl, from-timerh, to-timerl, to-timerh (deprecated)
        elif val <= 61:
    ...
    def _overflowe(self, val): #for overflow fixing
        #idea: replace overflowe with tj's implementation
        #
    ...
    def i_inst(self, inst): #deprecated
        if inst == 56:
            self.TIMER_RUNNING = True
            self.CTIMERSTART = self.CLOCK
        elif inst == 57:
            self.TIMER_RUNNING = False

    def j_inst(self, inst): #deprecated
        if inst == 58:
    ...
    def k_inst(self, inst):
        ...
        elif inst == 71: # timer <imm> (Deprecated)
    ...
    def n_inst(self, inst):
        ...
        if 160 <= inst <= 167: # bnz-a <imm>
            ...
            if self.CF != 0:
                ...
                self.PC += 2
        elif 208 <= inst <= 215: # b-timer (deprecated)
